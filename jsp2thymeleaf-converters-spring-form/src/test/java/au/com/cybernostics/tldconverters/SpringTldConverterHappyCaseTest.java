package au.com.cybernostics.tldconverters;
...
public class SpringTldConverterHappyCaseTest
{

    private static Logger LOG = Logger.getLogger(SpringTldConverterHappyCaseTest.class.getName());

    private final File jspFile;
    final URL rootResource;
    final Path rootPath;

    public SpringTldConverterHappyCaseTest(String name, File JSPFile) throws URISyntaxException
    {
        this.jspFile = JSPFile;
        rootResource = SpringTldConverterHappyCaseTest.class.getClassLoader().getResource("happy_case_files/");
    ...
    public void shouldConvertFile()
    {
        JSP2ThymeleafConfiguration configuration = JSP2ThymeleafConfiguration.getBuilder()
                .withConverterPackages("com.cybernostics.jsp2thymeleaf.conveters.tld")
                .build();
        ...
        try
        {
            ...
            assertThat("No errors", errors, is(empty()));
        ...
        {
            Logger.getLogger(SpringTldConverterHappyCaseTest.class.getName()).log(Level.SEVERE, null, ex);
    ...
    {
        final URL resource = SpringTldConverterHappyCaseTest.class.getClassLoader().getResource("happy_case_files");
